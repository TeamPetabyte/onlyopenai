...
(function (global) {
  ...
  var DICT = {
    th: {
      ...
      'modal.testSkill.verdictLabel': 'คำตัดสิน (senior)',
      ...
      'modal.testHistory.empty': 'ยังไม่มีการทดสอบ skill นี้',
      'modal.testHistory.question': 'โจทย์',
      'btn.history': 'ประวัติ',
      'nav.lab': 'Prompt Lab',
      'page.lab.title': '🧪 Prompt Lab',
      'page.lab.sub': 'ทดสอบคำถามกับ system prompt ของแต่ละ skill → ให้ senior ตัดสินคำตอบ → สะสมเป็นชุดเฉลย (golden dataset)',
      ...
      'lab.historyLabel': '📋 ประวัติการทดสอบ',
      ...
      'evals.needGolden': 'ต้องมีเฉลย หรือ verdict = ถูกต้อง ก่อน',
      'err.pickVerdict': 'เลือกคำตัดสินก่อน',
    ...
    en: {
      ...
      'modal.testSkill.verdictLabel': 'Verdict (senior)',
      ...
      'modal.testHistory.empty': 'No tests for this skill yet',
      'modal.testHistory.question': 'Question',
      'btn.history': 'History',
      'nav.lab': 'Prompt Lab',
      'page.lab.title': '🧪 Prompt Lab',
      'page.lab.sub': 'Test questions against each skill\'s system prompt → senior judges the answers → builds the golden dataset',
      ...
      'evals.needGolden': 'Needs a corrected answer or verdict = correct first',
      'err.pickVerdict': 'Pick a verdict first',
